...
export type IGameActions = {
  addActionTile: (params: { col?: number; playerId?: string, row?: number, selectedTile?: ITileKey }) => void;
...
Rune.initLogic({
  ...
  actions: {
    addActionTile: (params, { game, playerId }) => addActionTile(params, game, playerId),
    addSelectedTile: (params, { game }) => addSelectedTile(params, game),
    discardHandTile: (params, { game, playerId }) => discardHandTile(params, game, playerId),
    ...
    selectHandTile: (params, { game, playerId }) => selectHandTile(params, game, playerId),
  ...
  events: {
    ...
    playerLeft: (playerId, { game }) => {
      ...
      const aiNumbers = game.allPlayerIds.reduce((acc, id) => {
        if (isAi(id)) {
